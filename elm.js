								...
								_1: {
									...
									_1: {
										...
										_1: {
											...
											_0: A2(
												_debois$elm_mdl$Material_Options$when,
												(!_elm_lang$core$Native_Utils.eq(config.value, _elm_lang$core$Maybe$Nothing)) || model.isDirty,
															...
															if (_p12.ctor === 'Nothing') {
																return A2(
																	...
																	A2(
																		...
																		function (_p13) {
																			return lift(
																				_debois$elm_mdl$Material_Textfield$Input(_p13));
																		},
																		_elm_lang$html$Html_Events$targetValue));
															} else {
																return _debois$elm_mdl$Material_Options_Internal$attribute(
																	_elm_lang$html$Html_Attributes$defaultValue(_p12._0));
															}
														}(),
														_1: {ctor: '[]'}
													}
...
var _rofrol$elm_mdl_bug_240$Main$header = function (model) {
	return {
		ctor: '::',
		_0: A2(
			...
			{
				ctor: '::',
				_0: _debois$elm_mdl$Material_Options$cs('mdl-color--indigo-700'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
...
var _rofrol$elm_mdl_bug_240$Main$defaultModel = {mdl: _debois$elm_mdl$Material$model, clicked: false};
var _rofrol$elm_mdl_bug_240$Main$Model = F2(
	function (a, b) {
		return {mdl: a, clicked: b};
	});
var _rofrol$elm_mdl_bug_240$Main$Unclicked = {ctor: 'Unclicked'};
var _rofrol$elm_mdl_bug_240$Main$Clicked = {ctor: 'Clicked'};
var _rofrol$elm_mdl_bug_240$Main$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
var _rofrol$elm_mdl_bug_240$Main$init = {
	ctor: '_Tuple2',
	_0: _rofrol$elm_mdl_bug_240$Main$defaultModel,
	_1: _elm_lang$core$Platform_Cmd$batch(
		{
			ctor: '::',
			_0: _debois$elm_mdl$Material_Layout$sub0(_rofrol$elm_mdl_bug_240$Main$Mdl),
			_1: {ctor: '[]'}
		})
};
var _rofrol$elm_mdl_bug_240$Main$update = F2(
	function (action, model) {
		var _p0 = action;
		switch (_p0.ctor) {
			case 'Mdl':
				return A3(_debois$elm_mdl$Material$update, _rofrol$elm_mdl_bug_240$Main$Mdl, _p0._0, model);
			case 'Clicked':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
...
var _rofrol$elm_mdl_bug_240$Main$viewPage = function (model) {
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Click on the list icon at right ====>'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
				...
				_0: A2(
					...
					},
					{
						...
						_0: A5(
							...
							_rofrol$elm_mdl_bug_240$Main$Mdl,
							{
								ctor: '::',
								_0: 1,
								_1: {ctor: '[]'}
							...
							model.mdl,
							{
								...
								_1: {
									ctor: '::',
									_0: _debois$elm_mdl$Material_Options$onClick(_rofrol$elm_mdl_bug_240$Main$Unclicked),
									_1: {ctor: '[]'}
								}
							},
							{
				...
				},
				{
					...
					_0: A5(
						...
						model.mdl,
						{
							...
							_1: {
								ctor: '::',
								_0: _debois$elm_mdl$Material_Options$onClick(_rofrol$elm_mdl_bug_240$Main$Clicked),
								_1: {
									ctor: '::',
									_0: A2(
					...
					_1: {
						...
						_0: A5(
							...
							{
								ctor: '::',
								_0: _debois$elm_mdl$Material_Tooltip$bottom,
								_1: {
									ctor: '::',
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('TOOLTIP TEST'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('<==== Click on the add icon at left'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}),
...
var _rofrol$elm_mdl_bug_240$Main$view_ = function (model) {
	return function (contents) {
		...
		A4(
			...
			{
				header: _rofrol$elm_mdl_bug_240$Main$header(model),
				drawer: {ctor: '[]'},
				tabs: {
					ctor: '_Tuple2',
					_0: {ctor: '[]'},
				...
				main: {
					ctor: '::',
					_0: _debois$elm_mdl$Material_Options$stylesheet(''),
					_1: {
						ctor: '::',
						_0: _rofrol$elm_mdl_bug_240$Main$viewPage(model),
						_1: {ctor: '[]'}
					}
				}
			}));
};
var _rofrol$elm_mdl_bug_240$Main$view = _elm_lang$html$Html_Lazy$lazy(_rofrol$elm_mdl_bug_240$Main$view_);
var _rofrol$elm_mdl_bug_240$Main$main = _elm_lang$html$Html$program(
	{
		init: _rofrol$elm_mdl_bug_240$Main$init,
		view: _rofrol$elm_mdl_bug_240$Main$view,
		update: _rofrol$elm_mdl_bug_240$Main$update,
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _rofrol$elm_mdl_bug_240$Main$main !== 'undefined') {
    _rofrol$elm_mdl_bug_240$Main$main(Elm['Main'], 'Main', undefined);
}
